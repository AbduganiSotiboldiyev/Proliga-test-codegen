...
import sty from "./PlasmicMarketMember.module.css"; // plasmic-import: 68beYYzPzwVH/css
...
function PlasmicMarketMember__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__pOsWc)}>
        <div className={classNames(projectcss.all, sty.freeBox__cfF3)}>
          <PlasmicImg__
            alt={""}
            className={classNames(sty.img__emmQf, {
              [sty.imgborjaMayoral__emmQfvTnil]: hasVariant(
                $state,
                "borjaMayoral",
                "borjaMayoral"
              ),
              [sty.imgmendez__emmQfSDcx]: hasVariant(
                $state,
                "mendez",
                "mendez"
              ),
              [sty.imgpedri__emmQfcbqGa]: hasVariant($state, "pedri", "pedri")
            })}
            displayHeight={"112px"}
            ...
            src={
              hasVariant($state, "mendez", "mendez")
                ...
                ? {
                    src: "/plasmic/copy_of_proliga_test/images/ikerMunofizpng.png",
                    fullWidth: 256,
                    fullHeight: 256,
                    aspectRatio: undefined
                  }
                ...
                : {
                    src: "/plasmic/copy_of_proliga_test/images/rodrygopng.png",
                    fullWidth: 256,
                    fullHeight: 256,
                    aspectRatio: undefined
                  }
          ...
          <PlasmicImg__
            alt={""}
            className={classNames(sty.img__pzRix, {
              [sty.imgborjaMayoral__pzRiXvTnil]: hasVariant(
                $state,
                "borjaMayoral",
                "borjaMayoral"
              ),
              [sty.imgmendez__pzRixSDcx]: hasVariant(
                $state,
                "mendez",
                "mendez"
              ),
              [sty.imgpedri__pzRiXcbqGa]: hasVariant($state, "pedri", "pedri")
            })}
            displayHeight={"28px"}
            displayMaxHeight={"none"}
            displayMaxWidth={"100%"}
            ...
            src={
              hasVariant($state, "mendez", "mendez")
                ? {
                    src: "/plasmic/copy_of_proliga_test/images/osasunapng.png",
                    fullWidth: 120,
                    fullHeight: 120,
                    aspectRatio: undefined
                  }
                : hasVariant($state, "pedri", "pedri")
                ? {
                    src: "/plasmic/copy_of_proliga_test/images/fcBarcelonapng.png",
                    fullWidth: 96,
                    fullHeight: 100,
                    aspectRatio: undefined
                  }
                : hasVariant($state, "borjaMayoral", "borjaMayoral")
                ? {
                    src: "/plasmic/copy_of_proliga_test/images/cadizpng.png",
                    fullWidth: 1024,
                    fullHeight: 1024,
                    aspectRatio: undefined
                  }
                : {
                    src: "/plasmic/copy_of_proliga_test/images/realMadridpng.png",
                    fullWidth: 80,
                    fullHeight: 104,
                    aspectRatio: undefined
                  }
        ...
        <div className={classNames(projectcss.all, sty.freeBox__xg9PJ)}>
          <div className={classNames(projectcss.all, sty.freeBox__tZuDu)}>
            <PlasmicLink__
              className={classNames(
                projectcss.all,
                projectcss.a,
                ...
                sty.link__vSopq,
                {
                  [sty.linkmendez__vSopqSDcx]: hasVariant(
                    $state,
                    "mendez",
                    "mendez"
                  )
            ...
            <div
              className={classNames(
                ...
                sty.text__xxx3T,
                {
                  [sty.textborjaMayoral__xxx3TvTnil]: hasVariant(
                    $state,
                    "borjaMayoral",
                    "borjaMayoral"
                  ),
                  [sty.textmendez__xxx3TSDcx]: hasVariant(
                    $state,
                    "mendez",
                    "mendez"
                  ),
                  [sty.textpedri__xxx3TcbqGa]: hasVariant(
                    $state,
                    "pedri",
                    "pedri"
                  )
          ...
          <div className={classNames(projectcss.all, sty.freeBox__rF3RE)}>
            <div
              className={classNames(
                projectcss.all,
                projectcss.__wab_text,
        ...
        <div className={classNames(projectcss.all, sty.freeBox___9UyFj)}>
          <div className={classNames(projectcss.all, sty.freeBox__ceuFi)}>
            <PlasmicLink__
              className={classNames(
                projectcss.all,
                projectcss.a,
                ...
                sty.link__bNYp,
                {
                  [sty.linkborjaMayoral__bNYpVTnil]: hasVariant(
                    $state,
                    "borjaMayoral",
                    "borjaMayoral"
                  ),
                  [sty.linkmendez__bNYpSDcx]: hasVariant(
                    $state,
                    "mendez",
                    "mendez"
                  ),
                  [sty.linkpedri__bNYpCbqGa]: hasVariant(
                    $state,
                    "pedri",
                    "pedri"
                  )
