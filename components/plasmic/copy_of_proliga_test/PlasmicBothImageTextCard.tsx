...
import sty from "./PlasmicBothImageTextCard.module.css"; // plasmic-import: JqJ_iJAj7cbT/css
...
function PlasmicBothImageTextCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__we5Tp)}>
        <PlasmicImg__
          ...
          loading={"lazy"}
          src={{
            src: "/plasmic/copy_of_proliga_test/images/images1Jfif.jpg",
            fullWidth: 300,
            fullHeight: 168,
      ...
      <div className={classNames(projectcss.all, sty.freeBox__rd7VB)}>
        <div className={classNames(projectcss.all, sty.freeBox__ve06T)}>
          <Stack__
            as={"div"}
          ...
          >
            <div className={classNames(projectcss.all, sty.column__kzG4)}>
              <div
                className={classNames(
                  projectcss.all,
            ...
            <div className={classNames(projectcss.all, sty.column__fmOh0)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
