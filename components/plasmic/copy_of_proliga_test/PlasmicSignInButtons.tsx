...
import sty from "./PlasmicSignInButtons.module.css"; // plasmic-import: 5NmZaaqICRng/css
...
function PlasmicSignInButtons__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__kC3Tc)}>
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__opBO)}
        >
          <Button className={classNames("__wab_instance", sty.button__qzLQj)}>
            <div
              className={classNames(
                projectcss.all,
          ...
          <PlasmicLink__
            ...
            target={"_blank"}
          >
            <Button className={classNames("__wab_instance", sty.button__vzwYd)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
