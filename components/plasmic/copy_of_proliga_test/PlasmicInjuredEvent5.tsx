...
import sty from "./PlasmicInjuredEvent5.module.css"; // plasmic-import: 86VDswMGci5W/css
...
function PlasmicInjuredEvent5__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        <div className={classNames(projectcss.all, sty.column___6M0Ni)}>
          <div
            className={classNames(
              projectcss.all,
        ...
        <div
          className={classNames(projectcss.all, sty.column___2EvPt, {
            [sty.columngoalsAgainst___2EvPtOrWw]: hasVariant(
              $state,
              "goalsAgainst",
              "goalsAgainst"
            )
        ...
        >
          <div
            className={classNames(
              ...
              sty.text__xGtdl,
              {
                [sty.textballsIntoTheBox__xGtdlgzoOd]: hasVariant(
                  $state,
                  "ballsIntoTheBox",
                  "ballsIntoTheBox"
                ),
                [sty.textbigChanceCreated__xGtdl5Ggw7]: hasVariant(
                  $state,
                  "bigChanceCreated",
                  "bigChanceCreated"
                ),
                [sty.textcommitedPenalties__xGtdlx5KlA]: hasVariant(
                  $state,
                  "commitedPenalties",
                  "commitedPenalties"
                ),
                [sty.texteffectiveClearanes__xGtdl6O5G]: hasVariant(
                  $state,
                  "effectiveClearanes",
                  "effectiveClearanes"
                ),
                [sty.texteffectiveDribbles__xGtdlztkbf]: hasVariant(
                  $state,
                  "effectiveDribbles",
                  "effectiveDribbles"
                ),
                [sty.textgoalAssists__xGtdlZuBl]: hasVariant(
                  $state,
                  "goalAssists",
                  "goalAssists"
                ),
                [sty.textgoalAttempts__xGtdlKHdEk]: hasVariant(
                  $state,
                  "goalAttempts",
                  "goalAttempts"
                ),
                [sty.textgoalsAgainst__xGtdlOrWw]: hasVariant(
                  $state,
                  "goalsAgainst",
                  "goalsAgainst"
                ),
                [sty.textgoals__xGtdlNKqSp]: hasVariant(
                  $state,
                  "goals",
                  "goals"
                ),
                [sty.textlostBalls__xGtdlAqtK]: hasVariant(
                  $state,
                  "lostBalls",
                  "lostBalls"
                ),
                [sty.textownGoals__xGtdll79La]: hasVariant(
                  $state,
                  "ownGoals",
                  "ownGoals"
                ),
                [sty.textpenaltiesMissed__xGtdl1MU8X]: hasVariant(
                  $state,
                  "penaltiesMissed",
                  "penaltiesMissed"
                ),
                [sty.textpenaltiesSaved__xGtdlWxl1]: hasVariant(
                  $state,
                  "penaltiesSaved",
                  "penaltiesSaved"
                ),
                [sty.textpenaltiesWon__xGtdlEuwui]: hasVariant(
                  $state,
                  "penaltiesWon",
                  "penaltiesWon"
                ),
                [sty.textrecoviries__xGtdlvENvG]: hasVariant(
                  $state,
                  "recoviries",
                  "recoviries"
                ),
                [sty.textredCard__xGtdlQuCc]: hasVariant(
                  $state,
                  "redCard",
                  "redCard"
                ),
                [sty.textsaves__xGtdlFfnpf]: hasVariant(
                  $state,
                  "saves",
                  "saves"
                ),
                [sty.textsecondaryYellowCard__xGtdlYbrEt]: hasVariant(
                  $state,
                  "secondaryYellowCard",
                  "secondaryYellowCard"
                ),
                [sty.textyellowCard__xGtdlYMvW]: hasVariant(
                  $state,
                  "yellowCard",
                  "yellowCard"
                )
        ...
        <div className={classNames(projectcss.all, sty.column__xP3N5)}>
          <div
            className={classNames(
              projectcss.all,
              projectcss.__wab_text,
