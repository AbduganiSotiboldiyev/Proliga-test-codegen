...
import Rankings2 from "../../Rankings2"; // plasmic-import: b2NbL3JKxNOf/component
...
import sty from "./PlasmicRankings.module.css"; // plasmic-import: FPsA3LJIwlha/css
    ...
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          <div className={classNames(projectcss.all, sty.freeBox__vaZ2A)}>
            <div
              className={classNames(
                projectcss.all,
          ...
          <div className={classNames(projectcss.all, sty.freeBox__kb4L)}>
            <Stack__
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.freeBox__y6U3)}
            >
              <AntdDropdown
                className={classNames("__wab_instance", sty.dropdown__aNqV)}
                dropdownMenuScopeClassName={sty["dropdown__aNqV__dropdownMenu"]}
                menuItems={() => (
                  <React.Fragment>
                    <AntdMenuItem
                      className={classNames(
              ...
              >
                <AntdButton
                  className={classNames("__wab_instance", sty.button__ccFpe)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
              ...
              <AntdDropdown
                className={classNames("__wab_instance", sty.dropdown__gJhkp)}
                dropdownMenuScopeClassName={
                  sty["dropdown__gJhkp__dropdownMenu"]
                }
                menuItems={() => (
                  <React.Fragment>
                    <AntdMenuItem
              ...
              >
                <AntdButton
                  className={classNames("__wab_instance", sty.button__uqrxu)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
              ...
              <AntdDropdown
                className={classNames("__wab_instance", sty.dropdown__kkfD1)}
                dropdownMenuScopeClassName={
                  sty["dropdown__kkfD1__dropdownMenu"]
                }
                menuItems={() => (
                  <React.Fragment>
                    <AntdMenuItem
              ...
              >
                <AntdButton
                  className={classNames("__wab_instance", sty.button__ad0K2)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__aDyti)}>
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__di0Xm)}
              >
                <div className={classNames(projectcss.all, sty.freeBox__xPxEy)}>
                  <div
                    className={classNames(
                      projectcss.all,
                      projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__mPqk9)}>
                <div
                  className={classNames(projectcss.all, sty.freeBox___7FnMz)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
                  ...
                  <div
                    className={classNames(projectcss.all, sty.freeBox__zYlvY)}
                  >
                    <PlasmicImg__
