...
import sty from "./PlasmicImageCardText.module.css"; // plasmic-import: VPvEr9ZHXPAS/css
    ...
    >
      ...
      >
        <PlasmicImg__
          ...
          loading={"lazy"}
          src={{
            src: "/plasmic/copy_of_proliga_test/images/_1350731Jpeg.jpg",
            fullWidth: 3840,
            fullHeight: 2160,
        ...
        >
          ...
          >
            <div className={classNames(projectcss.all, sty.column__nGdU1)}>
              <div
                className={classNames(
                  projectcss.all,
            ...
            <Stack__
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.column__jenQx)}
            >
              <div
                className={classNames(
                  projectcss.all,
