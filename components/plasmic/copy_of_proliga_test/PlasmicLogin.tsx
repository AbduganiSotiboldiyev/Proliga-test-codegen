...
import AuthComponent from "../../AuthComponent"; // plasmic-import: gbibUEsabUXY/component
import LoginRegister from "../../LoginRegister"; // plasmic-import: PbPH6nJQOiQf/component
...
import sty from "./PlasmicLogin.module.css"; // plasmic-import: zppyZe4ZgqRO/css
    ...
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox__zU7Yl)}>
              <div
                className={classNames(
                  projectcss.all,
            ...
            <div className={classNames(projectcss.all, sty.freeBox___798Xc)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__tsUJw)}
                displayHeight={"26px"}
                ...
                loading={"lazy"}
                src={{
                  src: "/plasmic/copy_of_proliga_test/images/_555Webp.webp",
                  fullWidth: 512,
                  fullHeight: 512,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__whXso)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__bQYbh)}
                displayHeight={"auto"}
                displayMaxHeight={"none"}
                displayMaxWidth={"100%"}
                displayMinHeight={"0"}
            ...
            <div className={classNames(projectcss.all, sty.freeBox___608Ve)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__v2D8L)}
                displayHeight={"auto"}
                displayMaxHeight={"none"}
                displayMaxWidth={"100%"}
                displayMinHeight={"0"}
            ...
            <div className={classNames(projectcss.all, sty.freeBox__yrRfz)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
