...
import sty from "./PlasmicMatchesCalendar.module.css"; // plasmic-import: BeEap34IrQAp/css
...
function PlasmicMatchesCalendar__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__pZ1Gf)}>
        <CmsQueryRepeater
          ...
          <DataCtxReader__>
            {$ctx => (
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox___4VxRj)}
              >
                <div
                  className={classNames(projectcss.all, sty.freeBox___7NvtZ)}
                >
                  <CmsRowField
                    className={classNames(
                      "__wab_instance",
                      sty.cmsEntryField__wk9N9
                    )}
                ...
                <div className={classNames(projectcss.all, sty.freeBox__jPpwy)}>
                  <div
                    className={classNames(
                      projectcss.all,
                      projectcss.__wab_text,
                ...
                <div className={classNames(projectcss.all, sty.freeBox__f7YaL)}>
                  <CmsRowField
                    className={classNames(
                      "__wab_instance",
                      sty.cmsEntryField__tmxTq
                    )}
                    field={(() => {
                      try {
                        return undefined;
