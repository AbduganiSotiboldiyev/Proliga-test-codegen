...
import TextInput from "../../TextInput"; // plasmic-import: JF3iSV1__wLq/component
...
import sty from "./PlasmicAuthComponent.module.css"; // plasmic-import: gbibUEsabUXY/css

import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: tKT-cw5VkyT8/icon
...
function PlasmicAuthComponent__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div className={classNames(projectcss.all, sty.freeBox__wf3Di)}>
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__cNiOc)}
          displayHeight={"auto"}
          ...
          loading={"lazy"}
          src={{
            src: "/plasmic/copy_of_proliga_test/images/_754FacebookIconjpg.jpg",
            fullWidth: 866,
            fullHeight: 650,
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__aeChg, {
            [sty.freeBoxisSignUpFlow__aeChgY2RSz]: hasVariant(
              $state,
              "isSignUpFlow",
              "isSignUpFlow"
            )
        ...
        >
          <div
            className={classNames(
              ...
              sty.text__nCsVg,
              {
                [sty.textisSignUpFlow__nCsVgy2RSz]: hasVariant(
                  $state,
                  "isSignUpFlow",
                  "isSignUpFlow"
                )
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__kjZlK, {
          [sty.freeBoxisSignUpFlow__kjZlKy2RSz]: hasVariant(
            $state,
            "isSignUpFlow",
            "isSignUpFlow"
          )
      ...
      <div className={classNames(projectcss.all, sty.freeBox__zJ7Cf)}>
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img___6Koqm, {
            [sty.imgisSignUpFlow___6KoqmY2RSz]: hasVariant(
              $state,
              "isSignUpFlow",
              "isSignUpFlow"
            )
          ...
          loading={"lazy"}
          src={{
            src: "/plasmic/copy_of_proliga_test/images/googleGLogosvgpng.png",
            fullWidth: 768,
            fullHeight: 768,
            aspectRatio: undefined
          }}
        ...
        <div
          className={classNames(
            ...
            sty.text__ljrlj,
            {
              [sty.textisSignUpFlow__ljrljY2RSz]: hasVariant(
                $state,
                "isSignUpFlow",
                "isSignUpFlow"
              )
      ...
      <div className={classNames(projectcss.all, sty.freeBox__kLj3O)}>
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__nzhX)}
          displayHeight={"auto"}
          displayMaxHeight={"none"}
          displayMaxWidth={"100%"}
          displayMinHeight={"0"}
          ...
          loading={"lazy"}
          src={{
            src: "/plasmic/copy_of_proliga_test/images/imagespng.png",
            fullWidth: 266,
            fullHeight: 190,
            aspectRatio: undefined
          }}
        ...
        <div
          className={classNames(
            ...
            sty.text__gE7T7,
            {
              [sty.textisSignUpFlow__gE7T7Y2RSz]: hasVariant(
                $state,
                "isSignUpFlow",
                "isSignUpFlow"
              )
      ...
      {(() => {
        ...
        return (
          ...
          >
            <FormItemWrapper
              className={classNames("__wab_instance", sty.formField___8UyQ4, {
                [sty.formFieldisSignUpFlow___8UyQ4Y2RSz]: hasVariant(
                  $state,
                  "isSignUpFlow",
                  "isSignUpFlow"
                ),
                [sty.formFieldsignIn___8UyQ4SsBs0]: hasVariant(
                  $state,
                  "signIn",
                  "signIn"
                )
            ...
            <FormItemWrapper
              className={classNames("__wab_instance", sty.formField___4KCOy)}
              initialValue={undefined}
              label={""}
              name={"password"}
            >
            ...
            <FormItemWrapper
              className={classNames("__wab_instance", sty.formField__kVtgG, {
                [sty.formFieldisSignUpFlow__kVtgGy2RSz]: hasVariant(
                  $state,
                  "isSignUpFlow",
                  "isSignUpFlow"
                ),
                [sty.formFieldsignIn__kVtgGssBs0]: hasVariant(
                  $state,
                  "signIn",
                  "signIn"
                )
            ...
            <FormItemWrapper
              className={classNames("__wab_instance", sty.formField__rtExe)}
              initialValue={undefined}
              label={"phone_number"}
              name={"phone_number"}
            >
            ...
            <FormItemWrapper
              className={classNames("__wab_instance", sty.formField__ddXtC)}
              initialValue={undefined}
              label={"name"}
              name={"name"}
            >
            ...
            <AntdButton
              className={classNames("__wab_instance", sty.button__ri9Zb, {
                [sty.buttonsignIn__ri9ZbSsBs0]: hasVariant(
                  $state,
                  "signIn",
                  "signIn"
                )
      ...
      <div
        className={classNames(
          ...
          sty.text__txwq,
          {
            [sty.textisSignUpFlow__txwqY2RSz]: hasVariant(
              $state,
              "isSignUpFlow",
              "isSignUpFlow"
            )
      ...
      <div className={classNames(projectcss.all, sty.freeBox__r8JGi)}>
        <div
          className={classNames(projectcss.all, sty.freeBox__wscQ)}
        ...
        >
          <div
            className={classNames(
              ...
              sty.text__nUapI,
              {
                [sty.textisSignUpFlow__nUapIy2RSz]: hasVariant(
                  $state,
                  "isSignUpFlow",
                  "isSignUpFlow"
                )
          ...
          <div
            className={classNames(
              ...
              sty.text__q6Smn,
              {
                [sty.textisSignUpFlow__q6Smny2RSz]: hasVariant(
                  $state,
                  "isSignUpFlow",
                  "isSignUpFlow"
                )
          ...
          <div className={classNames(projectcss.all, sty.freeBox__rXoSx)}>
            <AntdRadio
          ...
          <Button
            className={classNames("__wab_instance", sty.button__i0MTq, {
              [sty.buttonisSignUpFlow__i0MTqy2RSz]: hasVariant(
                $state,
                "isSignUpFlow",
                "isSignUpFlow"
              )
          ...
          >
            <div
              className={classNames(
                ...
                sty.text__gpSuW,
                {
                  [sty.textisSignUpFlow__gpSuWy2RSz]: hasVariant(
                    $state,
                    "isSignUpFlow",
                    "isSignUpFlow"
                  )
          ...
          <div
            className={classNames(projectcss.all, sty.freeBox__i6KRr, {
              [sty.freeBoxisSignUpFlow__i6KRrY2RSz]: hasVariant(
                $state,
                "isSignUpFlow",
                "isSignUpFlow"
              )
          ...
          >
            <div
              className={classNames(
                ...
                sty.text__pU3Sn,
                {
                  [sty.textisSignUpFlow__pU3SnY2RSz]: hasVariant(
                    $state,
                    "isSignUpFlow",
                    "isSignUpFlow"
                  )
            ...
            <div
              className={classNames(
                ...
                sty.text__aUkMa,
                {
                  [sty.textisSignUpFlow__aUkMaY2RSz]: hasVariant(
                    $state,
                    "isSignUpFlow",
                    "isSignUpFlow"
                  )
