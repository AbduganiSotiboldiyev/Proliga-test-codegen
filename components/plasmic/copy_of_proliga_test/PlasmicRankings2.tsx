...
import sty from "./PlasmicRankings2.module.css"; // plasmic-import: b2NbL3JKxNOf/css
...
function PlasmicRankings2__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__jfDp3)}>
        <CmsQueryRepeater
          ...
          <DataCtxReader__>
            {$ctx =>
              (_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))([
                ...
                return (
                  <div
                    className={classNames(projectcss.all, sty.freeBox__uzXQw)}
                    key={currentIndex}
                  >
                    <div
                      className={classNames(projectcss.all, sty.freeBox__lwO4E)}
                    >
                      <CmsRowField
                        className={classNames(
                          "__wab_instance",
                          sty.cmsEntryField__mvfP0
                        )}
                        field={"avatar"}
                    ...
                    <div
                      className={classNames(projectcss.all, sty.freeBox__ti6R0)}
                    >
                      <CmsRowField
                        className={classNames(
                          "__wab_instance",
                          sty.cmsEntryField__hm6Zt
                        )}
                        themeResetClassName={classNames(
                          projectcss.root_reset,
                          projectcss.root_reset_tags,
