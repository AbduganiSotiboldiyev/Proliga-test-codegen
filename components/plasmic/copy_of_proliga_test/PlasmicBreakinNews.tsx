...
import BreakinNewsCards from "../../BreakinNewsCards"; // plasmic-import: oc-c7-lHaHnj/component
...
import sty from "./PlasmicBreakinNews.module.css"; // plasmic-import: NpoemCkVbo-x/css
    ...
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          <div className={classNames(projectcss.all, sty.columns__r7Bg3)}>
            <div className={classNames(projectcss.all, sty.column__hy5A3)}>
              <BreakinNewsCards
                className={classNames(
                  "__wab_instance",
                  sty.breakinNewsCards__iz2B2
                )}
              />
            </div>
            <div className={classNames(projectcss.all, sty.column__nLwiy)}>
              <BreakinNewsCards
                className={classNames(
                  "__wab_instance",
                  sty.breakinNewsCards___9GQo
                )}
                variant2={true}
              />
            </div>
            <div className={classNames(projectcss.all, sty.column___19Gy2)}>
              <BreakinNewsCards
                className={classNames(
                  "__wab_instance",
                  sty.breakinNewsCards__ecqCl
                )}
                variant3={true}
              />
            </div>
          </div>
          <div className={classNames(projectcss.all, sty.columns__yM9I)}>
            <div className={classNames(projectcss.all, sty.column__brWwr)}>
              <BreakinNewsCards
                className={classNames(
                  "__wab_instance",
                  sty.breakinNewsCards__cwSnl
                )}
                variant2={true}
              />
            </div>
            <div className={classNames(projectcss.all, sty.column___4UgtJ)}>
              <BreakinNewsCards
                className={classNames(
                  "__wab_instance",
                  sty.breakinNewsCards___9Ossu
                )}
              />
            </div>
            <div className={classNames(projectcss.all, sty.column__efOly)}>
              <BreakinNewsCards
                className={classNames(
                  "__wab_instance",
                  sty.breakinNewsCards__bti8Q
                )}
                rmTeam={true}
              />
            </div>
          </div>
          <div className={classNames(projectcss.all, sty.columns__dbczn)}>
            <div className={classNames(projectcss.all, sty.column__t33Ze)}>
              <BreakinNewsCards
                className={classNames(
                  "__wab_instance",
                  sty.breakinNewsCards__pXxBv
                )}
                variant3={true}
              />
            </div>
            <div className={classNames(projectcss.all, sty.column__voadm)}>
              <BreakinNewsCards
                className={classNames(
                  "__wab_instance",
                  sty.breakinNewsCards__xh5RI
                )}
                rmTeam={true}
              />
            </div>
            <div className={classNames(projectcss.all, sty.column__gnx1G)}>
              <BreakinNewsCards
                className={classNames(
                  "__wab_instance",
                  sty.breakinNewsCards__mateY
                )}
                variant2={true}
              />
            </div>
          </div>
          <div className={classNames(projectcss.all, sty.columns__fY6J0)}>
            <div className={classNames(projectcss.all, sty.column__kkm00)}>
              <BreakinNewsCards
                className={classNames(
                  "__wab_instance",
                  sty.breakinNewsCards___9N1QP
                )}
                rmTeam={true}
              />
            </div>
