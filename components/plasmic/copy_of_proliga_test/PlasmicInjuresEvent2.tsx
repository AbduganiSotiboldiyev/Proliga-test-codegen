...
import sty from "./PlasmicInjuresEvent2.module.css"; // plasmic-import: wjsaDXSd1Nbm/css
...
function PlasmicInjuresEvent2__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__rsH8T)}>
        <div
          data-plasmic-name={"columns"}
          data-plasmic-override={overrides.columns}
          className={classNames(projectcss.all, sty.columns)}
        >
          <div className={classNames(projectcss.all, sty.column__woQ5S)}>
            <div className={classNames(projectcss.all, sty.freeBox__atfgq)}>
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__fpOgX)}
                ...
                loading={"lazy"}
                src={{
                  src: "/plasmic/copy_of_proliga_test/images/xetafepng.png",
                  fullWidth: 96,
                  fullHeight: 104,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__sneNe)}>
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__r7U5G)}
                displayHeight={"32.5px"}
                displayMaxHeight={"none"}
                displayMaxWidth={"100%"}
                displayMinHeight={"0"}
                ...
                loading={"lazy"}
                src={{
                  src: "/plasmic/copy_of_proliga_test/images/freeRedHospitalClinicIcon10725Thumbpng.png",
                  fullWidth: 512,
                  fullHeight: 512,
                  aspectRatio: undefined
                }}
            ...
            <div className={classNames(projectcss.all, sty.freeBox__x179Y)}>
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__vonUh)}
                displayHeight={"32.5px"}
                displayMaxHeight={"none"}
                displayMaxWidth={"100%"}
                displayMinHeight={"0"}
                ...
                loading={"lazy"}
                src={{
                  src: "/plasmic/copy_of_proliga_test/images/freesvgorg59596Png.png",
                  fullWidth: 600,
                  fullHeight: 600,
                  aspectRatio: undefined
                }}
          ...
          <div className={classNames(projectcss.all, sty.column__yQhto)}>
            <div className={classNames(projectcss.all, sty.freeBox__rdYy5)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
            ...
            <div className={classNames(projectcss.all, sty.freeBox___6PKnX)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__qc640)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
