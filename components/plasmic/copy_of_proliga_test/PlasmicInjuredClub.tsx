...
import sty from "./PlasmicInjuredClub.module.css"; // plasmic-import: yNK2GOFSwGJf/css
  ...
  return (
    ...
    >
      ...
      >
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__huXX, {
            [sty.imgvariant1__huXX53SYa]: hasVariant(
              $state,
              "variant1",
              "variant1"
            ),
            [sty.imgvariant2__huXXTwYeq]: hasVariant(
              $state,
              "variant2",
              "variant2"
            ),
            [sty.imgvariant3__huXXHmkme]: hasVariant(
              $state,
              "variant3",
              "variant3"
            )
          ...
          src={
            hasVariant($state, "variant3", "variant3")
              ...
              : {
                  src: "/plasmic/copy_of_proliga_test/images/alavespng.png",
                  fullWidth: 120,
                  fullHeight: 120,
                  aspectRatio: undefined
                }
        ...
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__y5NO8)}
          displayHeight={"auto"}
          displayMaxHeight={"none"}
          displayMaxWidth={"100%"}
          displayMinHeight={"0"}
          ...
          loading={"lazy"}
          src={{
            src: "/plasmic/copy_of_proliga_test/images/_1200PxWarningsvgpng.png",
            fullWidth: 1200,
            fullHeight: 1108,
            aspectRatio: undefined
          }}
