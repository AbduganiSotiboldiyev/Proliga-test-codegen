...
import sty from "./PlasmicSearchComponent.module.css"; // plasmic-import: g4KtSvhR2cls/css
...
function PlasmicSearchComponent__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        <div className={classNames(projectcss.all, sty.column__jBWw)}>
          <div
            className={classNames(
              projectcss.all,
        ...
        <div className={classNames(projectcss.all, sty.column__uHvin)}>
          <div className={classNames(projectcss.all, sty.freeBox__sghG)}>
            <PlasmicImg__
              ...
              loading={"lazy"}
              src={{
                src: "/plasmic/copy_of_proliga_test/images/p1678T1861001000Png.png",
                fullWidth: 256,
                fullHeight: 256,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__oqy6T)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
