...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: JF3iSV1__wLq/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__pvfR)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__zfng4)}
              role={"img"}
            />
          ),
