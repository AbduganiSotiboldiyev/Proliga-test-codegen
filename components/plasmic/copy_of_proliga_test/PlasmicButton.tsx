...
import sty from "./PlasmicButton.module.css"; // plasmic-import: tMD_InG6VdHt/css
    ...
    <Stack__
      ...
      className={classNames(
        ...
        sty.login,
        {
          ...
          [sty.logincolor_sand_shape_rounded_size_compact]:
          ...
          [sty.loginshape_rounded_color_clear_size_compact]:
            hasVariant($state, "size", "compact") &&
            hasVariant($state, "shape", "rounded") &&
            hasVariant($state, "color", "clear"),
          [sty.loginshape_rounded_showEndIcon]:
          ...
          [sty.loginshape_rounded_size_compact]:
            hasVariant($state, "size", "compact") &&
            hasVariant($state, "shape", "rounded"),
          [sty.loginshape_rounded_size_compact_color_blue]:
            hasVariant($state, "color", "blue") &&
            hasVariant($state, "size", "compact") &&
            hasVariant($state, "shape", "rounded"),
          [sty.loginshape_rounded_size_compact_color_red]:
            hasVariant($state, "size", "compact") &&
            hasVariant($state, "shape", "rounded") &&
          ...
          [sty.loginsize_compact_color_blue]:
            hasVariant($state, "color", "blue") &&
            hasVariant($state, "size", "compact"),
          [sty.loginsize_compact_color_link]:
            hasVariant($state, "size", "compact") &&
            hasVariant($state, "color", "link"),
          [sty.loginsize_compact_shape_sharp_color_blue]:
            hasVariant($state, "color", "blue") &&
            hasVariant($state, "size", "compact") &&
          ...
          [sty.loginsize_minimal_color_blue]:
            hasVariant($state, "color", "blue") &&
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__nb3Ag)}
              role={"img"}
            />
          ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__fmcjd)}
                role={"img"}
              />
            ),
