...
import sty from "./PlasmicBreakinNewsCards.module.css"; // plasmic-import: oc-c7-lHaHnj/css
...
function PlasmicBreakinNewsCards__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__ss69S)}>
        <PlasmicImg__
          ...
          src={
            hasVariant($state, "rmTeam", "rmTeam")
              ? {
                  src: "/plasmic/copy_of_proliga_test/images/rmTeamwebp.webp",
                  fullWidth: 569,
                  fullHeight: 320,
              ...
              ? {
                  src: "/plasmic/copy_of_proliga_test/images/cimyAmelawebp.webp",
                  fullWidth: 569,
                  fullHeight: 320,
                  aspectRatio: undefined
                }
              ...
              ? {
                  src: "/plasmic/copy_of_proliga_test/images/athleticoMadridwebp.webp",
                  fullWidth: 569,
                  fullHeight: 320,
                  aspectRatio: undefined
                }
              : {
                  src: "/plasmic/copy_of_proliga_test/images/croswebp.webp",
                  fullWidth: 569,
                  fullHeight: 320,
                  aspectRatio: undefined
                }
        ...
        <div className={classNames(projectcss.all, sty.freeBox___1Ann3)}>
          <div
            className={classNames(
              projectcss.all,
        ...
        <div
          className={classNames(
            ...
            sty.text__zcOL,
            {
              [sty.textrmTeam__zcOLca9Ni]: hasVariant(
                $state,
                "rmTeam",
                "rmTeam"
              ),
              [sty.textvariant2__zcOLYCnfp]: hasVariant(
                $state,
                "variant2",
                "variant2"
              ),
              [sty.textvariant3__zcOLnOOmI]: hasVariant(
                $state,
                "variant3",
                "variant3"
              )
        ...
        <div
          className={classNames(
            ...
            sty.text___0YiAt,
            {
              [sty.textrmTeam___0YiATca9Ni]: hasVariant(
                $state,
                "rmTeam",
                "rmTeam"
              ),
              [sty.textvariant2___0YiAtyCnfp]: hasVariant(
                $state,
                "variant2",
                "variant2"
              ),
              [sty.textvariant3___0YiATnOOmI]: hasVariant(
                $state,
                "variant3",
                "variant3"
              )
