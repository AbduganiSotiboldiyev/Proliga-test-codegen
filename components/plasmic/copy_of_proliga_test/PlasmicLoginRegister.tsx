...
import sty from "./PlasmicLoginRegister.module.css"; // plasmic-import: PbPH6nJQOiQf/css
  ...
  return (
    ...
    >
      {renderPlasmicSlot({
        defaultContents: (
          <React.Fragment>
            <div className={classNames(projectcss.all, sty.freeBox___3RXfj)}>
              <div
                className={classNames(
                  projectcss.all,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__q3ZNu)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__eOIei)}
                displayHeight={"26px"}
            ...
            <div className={classNames(projectcss.all, sty.freeBox__rZw1U)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__fSz1W)}
                displayHeight={"auto"}
                displayMaxHeight={"none"}
                displayMaxWidth={"100%"}
                displayMinHeight={"0"}
            ...
            <div className={classNames(projectcss.all, sty.freeBox__sKglf)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__anMe)}
                displayHeight={"auto"}
                displayMaxHeight={"none"}
                displayMaxWidth={"100%"}
                displayMinHeight={"0"}
            ...
            <TextInput
              autoFocus={false}
              className={classNames("__wab_instance", sty.textInput__hteVk)}
              name={"Email"}
              type={"email"}
              value={(() => {
                try {
            ...
            <TextInput
              className={classNames("__wab_instance", sty.textInput__xEtxJ)}
            ...
            <div className={classNames(projectcss.all, sty.freeBox__d5TH)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
