...
import sty from "./PlasmicSearchComponent.module.css"; // plasmic-import: Udrurtr-96zx/css
...
function PlasmicSearchComponent__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        <div className={classNames(projectcss.all, sty.column__dhcvI)}>
          <div
            className={classNames(
              projectcss.all,
        ...
        <div className={classNames(projectcss.all, sty.column__ebDmz)}>
          <div className={classNames(projectcss.all, sty.freeBox__dqOk)}>
            <PlasmicImg__
              ...
              loading={"lazy"}
              src={{
                src: "/plasmic/proliga_test_duplicat/images/p1678T1861001000Png.png",
                fullWidth: 256,
                fullHeight: 256,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__rd6R1)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
