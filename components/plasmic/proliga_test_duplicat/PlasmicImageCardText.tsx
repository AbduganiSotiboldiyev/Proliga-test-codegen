...
import sty from "./PlasmicImageCardText.module.css"; // plasmic-import: Uy3JRKHKrxBh/css
    ...
    >
      ...
      >
        <PlasmicImg__
          ...
          loading={"lazy"}
          src={{
            src: "/plasmic/proliga_test_duplicat/images/_1350731Jpeg.jpg",
            fullWidth: 3840,
            fullHeight: 2160,
        ...
        >
          ...
          >
            <div className={classNames(projectcss.all, sty.column__f3Yp)}>
              <div
                className={classNames(
                  projectcss.all,
            ...
            <Stack__
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.column__dis2R)}
            >
              <div
                className={classNames(
                  projectcss.all,
