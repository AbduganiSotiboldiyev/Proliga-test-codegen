...
import sty from "./PlasmicRankings2.module.css"; // plasmic-import: sjr9GOIVDvbY/css
...
function PlasmicRankings2__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__otytw)}>
        <CmsQueryRepeater
          ...
          <DataCtxReader__>
            {$ctx =>
              (_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))([
                ...
                return (
                  <div
                    className={classNames(projectcss.all, sty.freeBox__yqCtM)}
                    key={currentIndex}
                  >
                    <div
                      className={classNames(projectcss.all, sty.freeBox__l29Ee)}
                    >
                      <CmsRowField
                        className={classNames(
                          "__wab_instance",
                          sty.cmsEntryField__fV4Ai
                        )}
                        field={"avatar"}
                    ...
                    <div
                      className={classNames(projectcss.all, sty.freeBox__hi99D)}
                    >
                      <CmsRowField
                        className={classNames(
                          "__wab_instance",
                          sty.cmsEntryField___1ATda
                        )}
                        themeResetClassName={classNames(
                          projectcss.root_reset,
                          projectcss.root_reset_tags,
