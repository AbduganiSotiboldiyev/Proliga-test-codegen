...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: AP1fWPq9HEu_/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__zu2Z4)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__tkuZ)}
              role={"img"}
            />
          ),
