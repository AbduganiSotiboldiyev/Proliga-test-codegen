...
import TextInput from "../../TextInput"; // plasmic-import: AP1fWPq9HEu_/component
...
import sty from "./PlasmicAuthComponent.module.css"; // plasmic-import: ZbZ0LN8SqYcJ/css

import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: IxbEnWlbnCXs/icon
...
function PlasmicAuthComponent__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div className={classNames(projectcss.all, sty.freeBox__tgiuz)}>
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__pp8Lm)}
          displayHeight={"auto"}
          ...
          loading={"lazy"}
          src={{
            src: "/plasmic/proliga_test_duplicat/images/_754FacebookIconjpg.jpg",
            fullWidth: 866,
            fullHeight: 650,
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__wv0RW, {
            [sty.freeBoxisSignUpFlow__wv0RWqkiwA]: hasVariant(
              $state,
              "isSignUpFlow",
              "isSignUpFlow"
            )
        ...
        >
          <div
            className={classNames(
              ...
              sty.text__u3Aix,
              {
                [sty.textisSignUpFlow__u3AixqkiwA]: hasVariant(
                  $state,
                  "isSignUpFlow",
                  "isSignUpFlow"
                )
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__zY8Ls, {
          [sty.freeBoxisSignUpFlow__zY8LSqkiwA]: hasVariant(
            $state,
            "isSignUpFlow",
            "isSignUpFlow"
          )
      ...
      <div className={classNames(projectcss.all, sty.freeBox__anMMg)}>
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img___0JmcY, {
            [sty.imgisSignUpFlow___0JmcYqkiwA]: hasVariant(
              $state,
              "isSignUpFlow",
              "isSignUpFlow"
            )
          ...
          loading={"lazy"}
          src={{
            src: "/plasmic/proliga_test_duplicat/images/googleGLogosvgpng.png",
            fullWidth: 768,
            fullHeight: 768,
            aspectRatio: undefined
          }}
        ...
        <div
          className={classNames(
            ...
            sty.text___0TjMa,
            {
              [sty.textisSignUpFlow___0TjMAqkiwA]: hasVariant(
                $state,
                "isSignUpFlow",
                "isSignUpFlow"
              )
      ...
      <div className={classNames(projectcss.all, sty.freeBox__sX7Mo)}>
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__svj81)}
          displayHeight={"auto"}
          displayMaxHeight={"none"}
          displayMaxWidth={"100%"}
          displayMinHeight={"0"}
          ...
          loading={"lazy"}
          src={{
            src: "/plasmic/proliga_test_duplicat/images/imagespng.png",
            fullWidth: 266,
            fullHeight: 190,
            aspectRatio: undefined
          }}
        ...
        <div
          className={classNames(
            ...
            sty.text__u5LAe,
            {
              [sty.textisSignUpFlow__u5LAeqkiwA]: hasVariant(
                $state,
                "isSignUpFlow",
                "isSignUpFlow"
              )
      ...
      {(() => {
        ...
        return (
          ...
          >
            <FormItemWrapper
              className={classNames("__wab_instance", sty.formField__vrS6I, {
                [sty.formFieldisSignUpFlow__vrS6IqkiwA]: hasVariant(
                  $state,
                  "isSignUpFlow",
                  "isSignUpFlow"
                ),
                [sty.formFieldsignIn__vrS6IOr70M]: hasVariant(
                  $state,
                  "signIn",
                  "signIn"
                )
            ...
            <FormItemWrapper
              className={classNames("__wab_instance", sty.formField__qe5Gk)}
              initialValue={undefined}
              label={""}
              name={"password"}
            >
            ...
            <FormItemWrapper
              className={classNames("__wab_instance", sty.formField__lkRqn, {
                [sty.formFieldisSignUpFlow__lkRqnqkiwA]: hasVariant(
                  $state,
                  "isSignUpFlow",
                  "isSignUpFlow"
                ),
                [sty.formFieldsignIn__lkRqnOr70M]: hasVariant(
                  $state,
                  "signIn",
                  "signIn"
                )
            ...
            <FormItemWrapper
              className={classNames("__wab_instance", sty.formField__uzRmx)}
              initialValue={undefined}
              label={"phone_number"}
              name={"phone_number"}
            >
            ...
            <FormItemWrapper
              className={classNames("__wab_instance", sty.formField___9W33S)}
              initialValue={undefined}
              label={"name"}
              name={"name"}
            >
            ...
            <AntdButton
              className={classNames("__wab_instance", sty.button__popL, {
                [sty.buttonsignIn__popLOr70M]: hasVariant(
                  $state,
                  "signIn",
                  "signIn"
                )
      ...
      <div
        className={classNames(
          ...
          sty.text__k39Vd,
          {
            [sty.textisSignUpFlow__k39VdqkiwA]: hasVariant(
              $state,
              "isSignUpFlow",
              "isSignUpFlow"
            )
      ...
      <div className={classNames(projectcss.all, sty.freeBox__p5BM)}>
        <div
          className={classNames(projectcss.all, sty.freeBox__rdYez)}
        ...
        >
          <div
            className={classNames(
              ...
              sty.text__o2BIh,
              {
                [sty.textisSignUpFlow__o2BIHqkiwA]: hasVariant(
                  $state,
                  "isSignUpFlow",
                  "isSignUpFlow"
                )
          ...
          <div
            className={classNames(
              ...
              sty.text__lm8VR,
              {
                [sty.textisSignUpFlow__lm8VRqkiwA]: hasVariant(
                  $state,
                  "isSignUpFlow",
                  "isSignUpFlow"
                )
          ...
          <div className={classNames(projectcss.all, sty.freeBox___34Jfi)}>
            <AntdRadio
          ...
          <Button
            className={classNames("__wab_instance", sty.button__jkFpb, {
              [sty.buttonisSignUpFlow__jkFpbqkiwA]: hasVariant(
                $state,
                "isSignUpFlow",
                "isSignUpFlow"
              )
          ...
          >
            <div
              className={classNames(
                ...
                sty.text__yFh2,
                {
                  [sty.textisSignUpFlow__yFh2QkiwA]: hasVariant(
                    $state,
                    "isSignUpFlow",
                    "isSignUpFlow"
                  )
          ...
          <div
            className={classNames(projectcss.all, sty.freeBox__tne0Y, {
              [sty.freeBoxisSignUpFlow__tne0YqkiwA]: hasVariant(
                $state,
                "isSignUpFlow",
                "isSignUpFlow"
              )
          ...
          >
            <div
              className={classNames(
                ...
                sty.text__njRwc,
                {
                  [sty.textisSignUpFlow__njRwcqkiwA]: hasVariant(
                    $state,
                    "isSignUpFlow",
                    "isSignUpFlow"
                  )
            ...
            <div
              className={classNames(
                ...
                sty.text___0Pyzg,
                {
                  [sty.textisSignUpFlow___0PyzgqkiwA]: hasVariant(
                    $state,
                    "isSignUpFlow",
                    "isSignUpFlow"
                  )
