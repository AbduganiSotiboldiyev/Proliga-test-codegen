...
import sty from "./PlasmicInjuredTeamMember.module.css"; // plasmic-import: PDN1UAI1YIQz/css
  ...
  return (
    ...
    >
      ...
      >
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__yzwb8)}
          displayHeight={"auto"}
        ...
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__a5Rne)}
          displayHeight={"20px"}
          displayMaxHeight={"none"}
          displayMaxWidth={"100%"}
          displayMinHeight={"0"}
          ...
          loading={"lazy"}
          src={{
            src: "/plasmic/proliga_test_duplicat/images/crossMedicalCircle512Webp.webp",
            fullWidth: 512,
            fullHeight: 512,
            aspectRatio: undefined
          }}
