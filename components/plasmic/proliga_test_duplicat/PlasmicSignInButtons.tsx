...
import sty from "./PlasmicSignInButtons.module.css"; // plasmic-import: w7YkHErZhQuS/css
...
function PlasmicSignInButtons__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__kQvcw)}>
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__cl4QO)}
        >
          <Button className={classNames("__wab_instance", sty.button__vfh9C)}>
            <div
              className={classNames(
                projectcss.all,
          ...
          <PlasmicLink__
            ...
            target={"_blank"}
          >
            <Button className={classNames("__wab_instance", sty.button__tCc9L)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
