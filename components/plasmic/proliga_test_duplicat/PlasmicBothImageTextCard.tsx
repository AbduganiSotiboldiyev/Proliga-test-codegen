...
import sty from "./PlasmicBothImageTextCard.module.css"; // plasmic-import: pnRYO8gTEGfN/css
...
function PlasmicBothImageTextCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__g5Fnx)}>
        <PlasmicImg__
          ...
          loading={"lazy"}
          src={{
            src: "/plasmic/proliga_test_duplicat/images/images1Jfif.jpg",
            fullWidth: 300,
            fullHeight: 168,
      ...
      <div className={classNames(projectcss.all, sty.freeBox___0OdY9)}>
        <div className={classNames(projectcss.all, sty.freeBox__gny7K)}>
          <Stack__
            as={"div"}
          ...
          >
            <div className={classNames(projectcss.all, sty.column__u8Rm4)}>
              <div
                className={classNames(
                  projectcss.all,
            ...
            <div className={classNames(projectcss.all, sty.column___6F0YI)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
