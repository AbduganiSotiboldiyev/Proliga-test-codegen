...
import AuthComponent from "../../AuthComponent"; // plasmic-import: ZbZ0LN8SqYcJ/component
import LoginRegister from "../../LoginRegister"; // plasmic-import: irko7nMPT0CP/component
...
import sty from "./PlasmicLogin.module.css"; // plasmic-import: duIHn5ZTmZw_/css
    ...
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox__pqBB)}>
              <div
                className={classNames(
                  projectcss.all,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__i0OqK)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img___8Rtli)}
                displayHeight={"26px"}
                ...
                loading={"lazy"}
                src={{
                  src: "/plasmic/proliga_test_duplicat/images/_555Webp.webp",
                  fullWidth: 512,
                  fullHeight: 512,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__npdOn)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__gHmsA)}
                displayHeight={"auto"}
                displayMaxHeight={"none"}
                displayMaxWidth={"100%"}
                displayMinHeight={"0"}
            ...
            <div className={classNames(projectcss.all, sty.freeBox__yBc27)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__ajNOa)}
                displayHeight={"auto"}
                displayMaxHeight={"none"}
                displayMaxWidth={"100%"}
                displayMinHeight={"0"}
            ...
            <div className={classNames(projectcss.all, sty.freeBox__a5OAu)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
