...
import sty from "./PlasmicButton.module.css"; // plasmic-import: p2h6o7H7daWs/css
    ...
    <Stack__
      ...
      className={classNames(
        ...
        sty.login,
        {
          ...
          [sty.loginshowStartIcon_showEndIcon_size_compact]:
            hasVariant($state, "size", "compact") &&
            hasVariant($state, "showStartIcon", "showStartIcon") &&
            hasVariant($state, "showEndIcon", "showEndIcon"),
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__yscg6)}
              role={"img"}
            />
          ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__t2Vjc)}
                role={"img"}
              />
            ),
