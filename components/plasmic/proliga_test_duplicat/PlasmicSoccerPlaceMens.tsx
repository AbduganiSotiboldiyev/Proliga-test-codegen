...
import IdealTeamMember from "../../IdealTeamMember"; // plasmic-import: UmSqECTkckcH/component
...
import sty from "./PlasmicSoccerPlaceMens.module.css"; // plasmic-import: F8IBfzCCDh8f/css
...
function PlasmicSoccerPlaceMens__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__qRyT)}>
        <IdealTeamMember
          className={classNames("__wab_instance", sty.idealTeamMember__zorFi)}
        />
      </div>
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__fc6Bq)}
      >
        <IdealTeamMember
          className={classNames("__wab_instance", sty.idealTeamMember__w6SWd)}
          sergioRamos={true}
        />

        <IdealTeamMember
          className={classNames("__wab_instance", sty.idealTeamMember__nu4F)}
          johnPache2={true}
        />

        <IdealTeamMember
          className={classNames("__wab_instance", sty.idealTeamMember__zuUhg)}
          mingueza={true}
        />
      </Stack__>
      <div className={classNames(projectcss.all, sty.freeBox__nq8Y3)}>
        <IdealTeamMember
          className={classNames("__wab_instance", sty.idealTeamMember__nBaQs)}
          zakaryan={true}
        />

        <IdealTeamMember
          className={classNames("__wab_instance", sty.idealTeamMember__xVtVb)}
          ikerMundez={true}
        />

        <IdealTeamMember
          className={classNames("__wab_instance", sty.idealTeamMember__jXSp9)}
          robertNav={true}
        />

        <IdealTeamMember
          alcaraz={true}
          className={classNames("__wab_instance", sty.idealTeamMember__v3Kdt)}
        />
      </div>
      <div className={classNames(projectcss.all, sty.freeBox__ewmSu)}>
        <IdealTeamMember
          className={classNames("__wab_instance", sty.idealTeamMember__aIwgA)}
          rodrygo={true}
        />

        <IdealTeamMember
          className={classNames("__wab_instance", sty.idealTeamMember___7D4Tz)}
          dovbyk={true}
        />

        <IdealTeamMember
          className={classNames("__wab_instance", sty.idealTeamMember__re4Rv)}
          willianJose={true}
        />
      </div>
    </div>
