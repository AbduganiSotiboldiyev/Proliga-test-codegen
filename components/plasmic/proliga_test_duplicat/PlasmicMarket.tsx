...
import sty from "./PlasmicMarket.module.css"; // plasmic-import: P8P90inaNzA2/css
    ...
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          >
            <div className={classNames(projectcss.all, sty.column___43R5W)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <MarketMember
                className={classNames(
                  "__wab_instance",
                  sty.marketMember__saDks
                )}
                mendez={true}
              />

              <MarketMember
                className={classNames("__wab_instance", sty.marketMember__jS6T)}
              />

              <MarketMember
                className={classNames(
                  "__wab_instance",
                  sty.marketMember__oiO2L
                )}
                mendez={true}
              />
              ...
              <MarketMember
                className={classNames(
                  "__wab_instance",
                  sty.marketMember__bdjXl
                )}
              />
            </div>
            <div className={classNames(projectcss.all, sty.column__xicsO)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <MarketMember
                borjaMayoral={true}
                className={classNames("__wab_instance", sty.marketMember__lfw)}
              />
              ...
              <MarketMember
                className={classNames(
                  "__wab_instance",
                  sty.marketMember__s3Fzo
                )}
              />

              <MarketMember
                borjaMayoral={true}
                className={classNames("__wab_instance", sty.marketMember__cFOo)}
              />

              <MarketMember
                className={classNames(
                  "__wab_instance",
                  sty.marketMember__aeMxy
                )}
              />
