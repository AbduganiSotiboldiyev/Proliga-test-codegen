...
import sty from "./PlasmicLoginRegister.module.css"; // plasmic-import: irko7nMPT0CP/css
  ...
  return (
    ...
    >
      {renderPlasmicSlot({
        defaultContents: (
          <React.Fragment>
            <div className={classNames(projectcss.all, sty.freeBox__qrgQ)}>
              <div
                className={classNames(
                  projectcss.all,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__p9EJk)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__egWdj)}
                displayHeight={"26px"}
            ...
            <div className={classNames(projectcss.all, sty.freeBox__fLkX6)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__xccZ)}
                displayHeight={"auto"}
                displayMaxHeight={"none"}
                displayMaxWidth={"100%"}
                displayMinHeight={"0"}
            ...
            <div className={classNames(projectcss.all, sty.freeBox__pKz2J)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__m4A9K)}
                displayHeight={"auto"}
                displayMaxHeight={"none"}
                displayMaxWidth={"100%"}
                displayMinHeight={"0"}
            ...
            <TextInput
              autoFocus={false}
              className={classNames("__wab_instance", sty.textInput__mSv9L)}
              name={"Email"}
              type={"email"}
              value={(() => {
                try {
            ...
            <TextInput
              className={classNames("__wab_instance", sty.textInput__hrSOd)}
            ...
            <div className={classNames(projectcss.all, sty.freeBox__cpUwD)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
